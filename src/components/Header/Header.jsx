      ...
      <AppBar position="static" style={{backgroundColor: 'transparent', boxShadow: 'none', color: 'black'}}>
        <Toolbar>
          ...
          > */}
            {/* <MenuIcon /> */}
          {/* </IconButton> */}
        <img style={{width: '70px' , height: '70px', borderRadius: '100%'}} src='https://image.freepik.com/free-vector/simple-sailing-yacht-silhouette-logo-design-inspiration_57043-361.jpg' />
          ...
          <div className={classes.grow} />
              <div className="hamburger-menu " style={{display: 'flex',alignItems:'center'}}>
                  ...
                  <ul className="navbar__menu menu__box">
                      ...
                      <li className="navbar__item icons"><ShoppingCartIcon/></li>
                      </Link>
                  </ul>
              </div>
